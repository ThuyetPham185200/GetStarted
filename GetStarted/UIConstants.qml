...
QtObject {
    ...
    readonly property string iRotateRight: "\uf01e"
    readonly property string iRotateLeft: "\uf2ea"
    ...
    readonly property color genBorderColor: "#00DFB2"
    ...
    property color titleColorOverlay: "#222f3e"
    ...
    readonly property FontLoader raceStripFont: FontLoader {
        source: "qrc:/fonts/RaceStripeDemo-PKgax.ttf"
    }
    readonly property FontLoader acidLabelFont: FontLoader {
        source: "qrc:/fonts/AcidLabelIi-YzMdo.ttf"
    }
    readonly property FontLoader americanFont: FontLoader {
        source: "qrc:/fonts/Americancardemo-DYVB1.ttf"
    }
    readonly property FontLoader planetFont: FontLoader {
        source: "qrc:/fonts/Planetcitydemo-BL7an.ttf"
    }
